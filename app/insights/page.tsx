...
import { generateInsightsSummaryServer } from "@/lib/actions/analyze";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function InsightsPage() {
      ...
      if (user) {
        try {
          ...
          if (userScans.length > 0) {
            ...
            const insights = await generateInsightsSummaryServer(userScans);
  ...
  const diseaseFrequency = scans.reduce((acc, scan) => {
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Analyze your crop health patterns and get AI-powered insights from
              your scan history.
            </p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Personalized recommendations based on your scan history
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {insightsLoading ? (
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Most commonly detected diseases in your crops
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Proportion of different diseases detected
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64">
              ...
              {trendData.length > 1 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Your scanning activity over time
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {Object.keys(diseaseFrequency).length}
                    </div>
